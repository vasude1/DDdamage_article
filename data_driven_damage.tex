...
\begin{figure}[]
	\begin{subfigure}{0.45\textwidth}
		...
		\caption{Bad metric, no snapback, and without the arc length constraint.}
	...
	\begin{subfigure}{0.45\textwidth}
		...
		\caption{Good metric, no snapback, and without the arc length constraint.}
		%\label{sn_dist_local}
	\end{subfigure}
	\begin{subfigure}{0.45\textwidth}
		\centering
		\includegraphics[scale=0.7]{./conv_figs/bad_metric_no_snap_arc_length.pdf}
		\caption{Bad metric, no snapback, and with the arc length constraint.}
		%\label{force_disp_local}
	\end{subfigure}
	\hfill
	\begin{subfigure}{0.45\textwidth}
		...
		\caption{Good metric, no snapback, and with the arc length constraint.}
		%\label{sn_dist_local}
	\end{subfigure}
\end{figure}
\begin{figure}\ContinuedFloat
	\begin{subfigure}{0.45\textwidth}
		...
		\caption{Bad metric, snapback, and with the arc length constraint.}
		%\label{force_disp_local}
	\end{subfigure}
	\hfill
	\begin{subfigure}{0.45\textwidth}
		...
		\caption{Good metric, snapback, and with the arc length constraint.}
		%\label{sn_dist_local}
	\end{subfigure}
	\begin{subfigure}{0.45\textwidth}
		\centering
		\includegraphics[scale=0.7]{./conv_figs/bad_metric_snap_no_arclength.pdf}
		\caption{Bad metric, snapback, and without the arc length constraint.}
		%\label{force_disp_local}
	\end{subfigure}
	\hfill
	\begin{subfigure}{0.45\textwidth}
		...
		\caption{Good metric, snapback, and without the arc length constraint.}
		%\label{sn_dist_local}
	\end{subfigure}
	\begin{subfigure}{0.45\textwidth}
		\centering
		\includegraphics[scale=0.7]{./conv_figs/bad_metric_snap_no_arclength_add.pdf}
		\caption{Bad metric, snapback, different initiation, and without the arc length constraint.}
		%\label{force_disp_local}
	\end{subfigure}
	\hfill
	\begin{subfigure}{0.45\textwidth}
		...
		\caption{Good metric, snapback, different initiation, and without the arc length constraint.}
		%\label{sn_dist_local}
	\end{subfigure}
	\caption{Results from the analysis various cases in 1D}
